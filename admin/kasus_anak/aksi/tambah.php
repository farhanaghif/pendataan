...
`umur_korban`, `kronologi_singkat`, `alamat`, `nama_wali_korban`, `nik_wali`, 
...
`alamat_pelaku`, `pekerjaan_pelaku`, `kontak_pelaku`, `satgas`) 
...
if ($result) {
    ...
    <script>
        ...
        window.location.href = '../tampilan/tambah_data_kasus_anak.php';
    </script>";
} else {
